...
export default function LeadFlowPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Lead Flow</h1>
      <p className="text-gray-600 text-lg leading-relaxed mb-6">
        Build a repeatable system that brings in consistent leads without burning out.
      </p>
