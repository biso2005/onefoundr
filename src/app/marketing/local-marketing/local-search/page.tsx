...
export const metadata = {
  title: "Dominating Local Search | OneFoundr",
  description: "Advanced local SEO, content strategy, and review growth to own your local market."
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-accent font-medium mb-6">
            Rank #1 for your service in your town
          </p>
          
          <p className="text-base text-textLight leading-relaxed mb-8 max-w-2xl mx-auto">
            Advanced local SEO, content strategy, and review growth to own your local market.
          </p>
