...
export const metadata = {
  title: "Local Marketing Foundations | OneFoundr",
  description: "Google Business Profile, first reviews, and basic local SEO—the essentials every local business needs."
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-accent font-medium mb-6">
            The non-negotiables that make you findable
          </p>
          
          <p className="text-base text-textLight leading-relaxed mb-8 max-w-2xl mx-auto">
            Google Business Profile, first reviews, and basic local SEO—the essentials every local business needs.
          </p>
