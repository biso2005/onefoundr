...
export const metadata = {
  title: "Neighborhood Marketing Tactics | OneFoundr",
  description: "Flyers, door hangers, yard signs, vehicle branding, and local events—offline marketing that works."
};

export default function NeighborhoodTacticsPage() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center">
          ...
          <p className="text-base text-textLight leading-relaxed mb-8 max-w-2xl mx-auto">
            Flyers, door hangers, yard signs, vehicle branding, and local events—offline marketing that works.
          </p>
