...
export const metadata = {
  title: "Building a Local Referral Engine | OneFoundr",
  description: "Systems for asking, tracking, and rewarding referrals that keep new customers coming."
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="text-center">
          ...
          <p className="text-base text-textLight leading-relaxed mb-8 max-w-2xl mx-auto">
            Systems for asking, tracking, and rewarding referrals that keep new customers coming.
          </p>
