...
export const metadata = {
  title: "Problem Discovery for Solopreneurs — OneFoundr",
  description: "Learn what your customers actually struggle with before building your solution."
};
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingLeft: "24px", paddingRight: "24px", paddingTop: "64px", paddingBottom: "64px" }}>
        <div style={{ marginBottom: "48px" }}>
          ...
          <div style={{ fontSize: "16px", color: "#636E72", lineHeight: "1.8" }}>
            <p>
              Learn what your customers actually struggle with. This step helps you uncover the real, underlying problems your audience faces—so you can build a solution they actually need.
            </p>
          </div>
        </div>
