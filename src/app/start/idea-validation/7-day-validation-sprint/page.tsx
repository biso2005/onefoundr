...
export default function SevenDayValidationSprintPage() {
  return (
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingLeft: "24px", paddingRight: "24px", paddingTop: "64px", paddingBottom: "64px" }}>
        <div style={{ marginBottom: "48px" }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 6vw, 48px)", fontWeight: "700", color: "#2D3436", marginBottom: "24px", lineHeight: "1.2" }}>
            The 7-Day Solo Validation Sprint
          </h1>
          ...
          <div style={{ fontSize: "16px", color: "#636E72", lineHeight: "1.8" }}>
            <p>
              Validate your business idea in one week using a lightweight process designed for solopreneurs. This guide walks you through a proven 7-day sprint that combines customer research, demand validation, and feasibility testing—all while keeping your day job or managing other commitments.
            </p>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: "#F0F9FF", borderRadius: "12px", padding: "24px", marginBottom: "48px", borderLeft: "4px solid #0EA5E9", border: "1px solid #E0F2FE" }}>
          ...
          <p style={{ margin: "8px 0 0 0", color: "#0369A1", fontSize: "14px" }}>
            Deep-dive guides with step-by-step implementation are coming soon. Subscribe to our newsletter to get notified when this guide is ready.
          </p>
        </div>
