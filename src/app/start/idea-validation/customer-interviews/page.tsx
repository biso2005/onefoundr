...
export const metadata = {
  title: "Customer Interviews — Validate Willingness to Pay — OneFoundr",
  description: "Talk to 10 people and validate that they'll actually pay for your solution."
};
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingLeft: "24px", paddingRight: "24px", paddingTop: "64px", paddingBottom: "64px" }}>
        <div style={{ marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "12px", fontWeight: "600", color: "#00B894", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "24px" }}>
            Validation Step • 9 min read
          </p>
          
          <div style={{ fontSize: "16px", color: "#636E72", lineHeight: "1.8" }}>
            <p>
              Talk to 10 people and validate willingness to pay. This is where you move beyond theory and have real conversations with potential customers to confirm they value your solution enough to pay for it.
            </p>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: "#F0F9FF", borderRadius: "12px", padding: "24px", marginBottom: "48px", borderLeft: "4px solid #0EA5E9", border: "1px solid #E0F2FE" }}>
          ...
          <p style={{ margin: "8px 0 0 0", color: "#0369A1", fontSize: "14px" }}>
            Deep-dive guides with customer interview scripts and pricing validation methods are coming soon. Subscribe to our newsletter to get notified when this guide is ready.
          </p>
        </div>
