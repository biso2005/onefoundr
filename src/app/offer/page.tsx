  ...
  return (
    <>
      ...
      <p className="text-gray-600 text-lg max-w-2xl mb-8 mx-auto text-center">
        Turn your skills into products and services that sell. Learn to create, price, and package offers that generate recurring revenue without undervaluing your expertise.
      </p>
    </>
  );
}
