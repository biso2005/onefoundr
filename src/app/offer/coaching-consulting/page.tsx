...
export const metadata = {
  title: "Coaching & Consulting — OneFoundr",
...
export default function CoachingConsultingPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <h1 className="text-4xl font-bold text-gray-900 mb-4">Coaching & Consulting</h1>
      <p className="text-gray-600 text-lg leading-relaxed mb-6">
        Turn your expertise into high-margin, low-overhead 1:1 or group engagements.
      </p>
